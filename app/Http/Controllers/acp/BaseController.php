...
class BaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("acp." . $this->page . ".all", $compact);
    }
    public function create(Request $request)
    {
        ...
        if (view()->exists("acp." . $this->page . ".form")) {
            return view("acp." . $this->page . ".form", $compact);
        }



        return view("acp." . $this->page . ".create", $compact);
    }
    ...
    public function show(Request $request)
    {
        ...
        return view("acp." . $this->page . ".show", $compact);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view("acp." . $this->page . ".edit", $compact);
    }
